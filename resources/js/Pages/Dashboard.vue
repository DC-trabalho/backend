...
<template>
  <div class="px-4 lg:px-24 py-8">
    <div class="md:w-[70%] relative group mx-auto">
      <h2 class="text-xl font-inria absolute">Heróis</h2>
      ...
      <button class="absolute top-1/2 -left-16 transform -translate-y-1/2 z-10 hidden md:block"
      ...
      <button class="absolute top-1/2 -right-16 transform -translate-y-1/2 z-10 hidden md:block"
